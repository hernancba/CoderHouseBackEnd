...
module.exports = class cl_Producto {
    ...
    static #arrProductos = [
        {
            ...
            price: 800,
            thumbnail: "/public/images/destornillador.png",
        },
        {
            id: 2,
            title: "Pinza",
            price: 1000,
            thumbnail: "/public/images/pinza.jpg",
        },
        {
            id: 3,
            title: "Alicate",
            price: 1200,
            thumbnail: "/public/images/alicate.jfif",
        },
    ];

    //Obtengo máximo id para usar en setProducto
    #getMaxId(){
    ...
    //Devuelve un producto según el id ingresado
